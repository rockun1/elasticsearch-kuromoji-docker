...
ENV ELASTICSEARCH_DEB_VERSION 6.3.0

# copy source code
RUN wget -q https://github.com/elastic/elasticsearch/archive/v6.3.0.tar.gz -O /usr/local/src/elasticsearch-source-v6.3.0.tar.gz
